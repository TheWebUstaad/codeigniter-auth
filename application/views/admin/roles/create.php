                ...
                <div class="card-body">
                    ...
                    <?php echo form_open('Admin/create_role'); ?>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="role_name" id="role_name" class="form-control" value="<?php echo set_value('role_name'); ?>" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="description">Description</label>
                            <textarea name="description" id="description" class="form-control" rows="3"><?php echo set_value('description'); ?></textarea>
                        </div>
                                                    ...
                                                    <?php foreach($permissions as $permission): ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-check mb-2">
                                                                <input type="checkbox" name="permissions[]" class="form-check-input" id="perm_<?= $permission->id ?>" value="<?= $permission->id ?>" <?= set_checkbox('permissions[]', $permission->id); ?>>
